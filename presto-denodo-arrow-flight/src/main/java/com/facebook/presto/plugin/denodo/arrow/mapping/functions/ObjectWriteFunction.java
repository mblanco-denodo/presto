 ...
 */
package com.facebook.presto.plugin.denodo.arrow.mapping.functions;
        ...
        extends WriteFunction
{
    ...
    void set(FlightSqlClient.PreparedStatement statement, int index, Object value);
    ...
    static <T> ObjectWriteFunction of(Class<T> javaType, ObjectWriteFunctionImplementation<T> implementation)
    {
        ...
        return new ObjectWriteFunction()
        {
            ...
            public void set(FlightSqlClient.PreparedStatement statement, int index, Object value)
            {
    ...
    {
        void set(FlightSqlClient.PreparedStatement statement, int index, T value);
    }
}
